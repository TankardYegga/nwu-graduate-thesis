...
def gcmc_train_and_test(model):
    
    os.environ["CUDA_VISIBLE_DEVICES"] = "0"

    t0 = time()
    print('GCMC training starts ...')
    ...
    tf.summary.text('gcmc model params num:', tf.convert_to_tensor(str(total_param_nums)))
    ...
    checkpoints_dir = '/home/exp/SMGCN/SMGCN/data/gcmc/checkpoints'
    ...
    embeddings_dir = '/home/exp/SMGCN/SMGCN/data/gcmc/embeddings/'
    ...
    perf_dir = '/home/exp/SMGCN/SMGCN/data/gcmc/performances/'
    ...
    logs_dir = '/home/exp/SMGCN/SMGCN/data/gcmc/logs'
...
if __name__ == "__main__":
    ...
    from models.gcmc.gcmc_parser import parse_args
    ...
    model = GCMC(data_generator=data_generator, args=args)
    print(model.opt)
    gcmc_train_and_test(model)
