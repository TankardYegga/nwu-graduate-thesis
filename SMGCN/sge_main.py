...
def sge_train_and_test(model):
    
    os.environ["CUDA_VISIBLE_DEVICES"] = "2"

    t0 = time()
    print('SGE training starts ...')
    ...
    tf.summary.text('SGE model params num:', tf.convert_to_tensor(str(total_param_nums)))
    ...
    checkpoints_dir = '/home/exp/SMGCN/SMGCN/data/sge/checkpoints'
    ...
    # embeddings_dir = '/home/exp/SMGCN/SMGCN/data/sge/embeddings/'
    ...
    perf_dir = '/home/exp/SMGCN/SMGCN/data/sge/performances/'
    ...
    logs_dir = '/home/exp/SMGCN/SMGCN/data/sge/logs'
...
if __name__ == "__main__":
    ...
    model = SGE(data_generator=data_generator, args=args)
    sge_train_and_test(model)
