...
from models.smgcn.bipar_gcn import *
from utils import *
...
def bipar_gcn_train_and_test(model):
    
    os.environ["CUDA_VISIBLE_DEVICES"] = "1"

    t0 = time()
    print('BiparGCN training starts ...')
    ...
    tf.summary.text('BiparGCN model params num:', tf.convert_to_tensor(str(total_param_nums)))
    ...
    checkpoints_dir = '/home/exp/SMGCN/SMGCN/data/bipar_gcn/checkpoints'
    ...
    embeddings_dir = '/home/exp/SMGCN/SMGCN/data/bipar_gcn/embeddings/'
    ...
    perf_dir = '/home/exp/SMGCN/SMGCN/data/bipar_gcn/performances/'
    ...
    logs_dir = '/home/exp/SMGCN/SMGCN/data/bipar_gcn/logs'
...
if __name__ == "__main__":
    ...
    model = BiparGCN(data_generator=data_generator, args=args)
    bipar_gcn_train_and_test(model)
