#coding=utf-8
from models.smgcn.smgcn_bpr import SMGCN_BPR
...
from models.smgcn.smgcn import *
from utils import *
...
def smgcn_bpr_train_and_test(model):
    
    os.environ["CUDA_VISIBLE_DEVICES"] = "2"

    t0 = time()
    print('SMGCN bpr training starts ...')
    ...
    checkpoints_dir = '/home/exp/SMGCN/SMGCN/data/smgcn_bpr/checkpoints'
    ...
    # embeddings_dir = '/home/exp/SMGCN/SMGCN/data/smgcn_bpr/embeddings/'
    ...
    perf_dir = '/home/exp/SMGCN/SMGCN/data/smgcn_bpr/performances/'
    ...
    logs_dir = '/home/exp/SMGCN/SMGCN/data/smgcn_bpr/logs'
    ...
    """
    n_batch = model.data_generator.n_train // args.batch_size + 1
    print('The N BATCH IS', n_batch)
    ...
    for epoch in range(args.epoch):
        ...
        for index in range(n_batch):
            ...
            # batch_sympt_set_mat, batch_herb_set_mat, sympt_set_normalized_mat = model.data_generator.sample_for_ngcf_bpr()
...
if __name__ == "__main__":
    ...
    from models.smgcn.smgcn_parser import parse_args
    ...
    model = SMGCN_BPR(data_generator=data_generator, args=args)
    smgcn_bpr_train_and_test(model)

    # interact_sess = tf.InteractiveSession()
    # for variable in tf.trainable_variables():
    #     variable.initializer.run()
    #     print(type(variable))
    #     print(variable)
    #     print(variable.name)
    #     print(interact_sess.run(variable))
