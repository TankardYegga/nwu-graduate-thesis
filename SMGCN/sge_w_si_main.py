...
from models.smgcn.sge_w_si import *
from utils import *
...
def sge_w_si_train_and_test(model):
    ...
    tf.summary.text('SGE_W_SI model params num:', tf.convert_to_tensor(str(total_param_nums)))
    ...
    checkpoints_dir = '/home/exp/SMGCN/SMGCN/data/sge_w_si/checkpoints'
    ...
    embeddings_dir = '/home/exp/SMGCN/SMGCN/data/sge_w_si/embeddings/'
    ...
    perf_dir = '/home/exp/SMGCN/SMGCN/data/sge_w_si/performances/'
    ...
    logs_dir = '/home/exp/SMGCN/SMGCN/data/sge_w_si/logs'
...
if __name__ == "__main__":
    ...
    model = SGE_W_SI(data_generator=data_generator, args=args)
    sge_w_si_train_and_test(model)
