...
def parse_args():
    ...
    parser.add_argument('--input-dim', type=int, default=64,
                        help='Initial input dim for both symptom and herb.')
    parser.add_argument('--hidden-dims', nargs='?', default='[64, 128]')
    parser.add_argument('--output-dims',nargs='?', default='[128, 64]')
