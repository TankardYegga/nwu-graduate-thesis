...
def parse_args():
    ...
    # 初始嵌入维度固定为64
    parser.add_argument('--hidden-size', nargs='?', default='[256]')
     # 第一层的输出维度默认为128，最后一层的输出维度在{64,128,256,512}中选择
    parser.add_argument('---weight_size', nargs='?', default='[256]',
    ...
    parser.add_argument('--sge_num_layers', type=int, default=1,
                        help='num of gcn layers of sge in smgcn')
    ...
    parser.add_argument('--model_type', nargs='?', default='smgcn',
