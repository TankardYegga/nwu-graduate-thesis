...
from models.smgcn.bipar_gcn_w_sge import *
from utils import *
...
def bipar_gcn_w_sge_train_and_test(model):
    
    os.environ["CUDA_VISIBLE_DEVICES"] = "1"

    t0 = time()
    print('BiparGCN_W_SGE training starts ...')
    ...
    tf.summary.text('BiparGCN_W_SGE model params num:', tf.convert_to_tensor(str(total_param_nums)))
    ...
    checkpoints_dir = '/home/exp/SMGCN/SMGCN/data/bipar_gcn_w_sge/checkpoints'
    ...
    embeddings_dir = '/home/exp/SMGCN/SMGCN/data/bipar_gcn_w_sge/embeddings/'
    ...
    perf_dir = '/home/exp/SMGCN/SMGCN/data/bipar_gcn_w_sge/performances/'
    ...
    logs_dir = '/home/exp/SMGCN/SMGCN/data/bipar_gcn_w_sge/logs'
...
if __name__ == "__main__":
    ...
    model = BiparGCN_W_SGE(data_generator=data_generator, args=args)
    bipar_gcn_w_sge_train_and_test(model)
