...
from models.smgcn.bipar_gcn_w_si import *
from utils import *
...
def bipar_gcn_w_si_train_and_test(model):
    
    os.environ["CUDA_VISIBLE_DEVICES"] = "2"

    t0 = time()
    print('BiparGCN_W_SI training starts ...')
    ...
    tf.summary.text('BiparGCN_W_SI model params num:', tf.convert_to_tensor(str(total_param_nums)))
    ...
    checkpoints_dir = '/home/exp/SMGCN/SMGCN/data/bipar_gcn_w_si/checkpoints'
    ...
    embeddings_dir = '/home/exp/SMGCN/SMGCN/data/bipar_gcn_w_si/embeddings/'
    ...
    perf_dir = '/home/exp/SMGCN/SMGCN/data/bipar_gcn_w_si/performances/'
    ...
    logs_dir = '/home/exp/SMGCN/SMGCN/data/bipar_gcn_w_si/logs'
...
if __name__ == "__main__":
    ...
    model = BiparGCN_W_SI(data_generator=data_generator, args=args)
    bipar_gcn_w_si_train_and_test(model)
