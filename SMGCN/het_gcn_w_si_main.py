#coding=utf-8
from models.het_gcn.hetgcn import HetGCN
import tensorflow as tf
import os
import sys
import numpy as np
from time import time
from models.smgcn import *
from models.het_gcn.het_gcn_w_si import *
from utils import *
...
def hetgcn_train_and_test(model):
    
    os.environ["CUDA_VISIBLE_DEVICES"] = "1"

    t0 = time()
    print('HetGCN training starts ...')
    ...
    tf.summary.text('hetgcn model params num:', tf.convert_to_tensor(str(total_param_nums)))
    ...
    checkpoints_dir = '/home/exp/SMGCN/SMGCN/data/het_gcn_w_si/checkpoints'
    ...
    embeddings_dir = '/home/exp/SMGCN/SMGCN/data/het_gcn_w_si/embeddings/'
    ...
    perf_dir = '/home/exp/SMGCN/SMGCN/data/het_gcn_w_si/performances/'
    ...
    logs_dir = '/home/exp/SMGCN/SMGCN/data/het_gcn_w_si/logs'
...
if __name__ == "__main__":
    ...
    from models.het_gcn.hetgcn_parser import parse_args
    ...
    # model = HetGCN(data_generator=data_generator, args=args)
    model = HetGCN_W_SI(data_generator=data_generator, args=args)
    hetgcn_train_and_test(model)
